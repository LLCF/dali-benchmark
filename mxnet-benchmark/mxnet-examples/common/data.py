...
class HybridTrainPipe(Pipeline):
    def __init__(self, batch_size, db_folder, num_threads, device_id, num_gpus):
        super(HybridTrainPipe, self).__init__(batch_size, num_threads, device_id, seed = device_id)
